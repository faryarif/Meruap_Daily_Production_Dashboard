"""
Daily Production & Well Map Dashboard — Supabase (direct PostgreSQL)
------------------------------------------------------------------
Run locally:
...
Streamlit secrets (.streamlit/secrets.toml):
    [supabase]
    url = "postgresql://postgres:[YOUR-PASSWORD]@db.xxxx.supabase.co:5432/postgres"
...
# ----------------------------------------------------------------------------
def get_conn():
    """Direct PostgreSQL connection to Supabase — bypasses REST API row limits."""
...
if using_sample:
    ...
    if db_connected:
        st.info("No data yet — import rows into ProdWellBasiss and HeaderID in Supabase.")
...
if using_sample:
    st.caption("⚠️ Showing sample data — connect Supabase and import your data.")
else:
    st.caption("✅ Showing live data from Supabase.")
